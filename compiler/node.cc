...
static const std::string kNodeRuleString[] = {
    ...
    "FUNCTION_PARAMETERS", "FUNCTION_PARAMETER", "BLOCK", "DEFAULT", "NEW", "ASSIGN",
    "RETURN", "IF", "FOR", "LOOP_INITIALIZE", "LOOP_CONDITION", "LOOP_UPDATE",
    "EXPRESSION", "MEMBER", "CALL", "CALL_PARAMETERS", "SYMBOL",
